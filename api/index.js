...
function getCategories(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT * FROM products JOIN merk ON merk.m_id = products.merk_id JOIN categorie ON categorie.c_id = products.categorie_id ORDER BY id ASC')
